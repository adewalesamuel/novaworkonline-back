        ...
        <div class="resume-wrapper-inner mx-auto text-left bg-white shadow-lg">
                    ...
                    <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
                        <div class="primary-info">
                            <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">
                                {{$resume['content']->personal_infos->firstname ?? ''}} {{$resume['content']->personal_infos->lastname ?? ''}}
                            </h1>
                            <div class="title mb-3">{{$resume['content']->personal_infos->profile_title ?? ''}}</div>
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <a href="mailto:{{$resume['content']->personal_infos->email ?? ''}}">
                                        <i class="fa fa-envelope fa-fw mr-2" data-fa-transform="grow-3"></i>
                                        @if ($is_recruiter)
                                            XXXXXXXXXX
                                        @else
                                            {{$resume['content']->personal_infos->email ?? ''}}
                                        @endif
                                    </a>
                                    </li>
                                <li>
                                    <a>
                                        <i class="fa fa-phone fa-fw mr-2" data-fa-transform="grow-6"></i>
                                        @if ($is_recruiter)
                                            XXXXXXXXXX
                                        @else
                                            {{$resume['content']->personal_infos->phone_number ?? ''}}
                                        @endif
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="resume-body p-5">
                <section class="resume-section summary-section mb-5">
                    <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">À propos de moi</h2>
                    <div class="resume-section-content">
                        <p class="mb-0">{{$resume['content']->profil ?? ''}}</p>
                    </div>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <section class="resume-section experience-section mb-5">
                            <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Expérience professionnelle</h2>
                            <div class="resume-section-content">
                                @forelse ($resume['content']->work_experience as $work_experience)
                                    <div class="resume-timeline position-relative">
                                        <article class="resume-timeline-item position-relative pb-5">
                                            <div class="resume-timeline-item-header mb-2">
                                                <div class="d-flex flex-column flex-md-row">
                                                    <h3 class="resume-position-title font-weight-bold mb-1">{{ $work_experience->position ?? '' }}</h3>
                                                    <div class="resume-company-name ml-auto">
                                                        {{ $work_experience->company ?? '' }}
                                                    </div>
                                                </div>
                                                <div class="resume-position-time">{{ $work_experience->start_date_month ?? '' }} {{ $work_experience->start_date_year ?? '' }} — {{ $work_experience->end_date_month ?? '' }} {{ $work_experience->end_date_year ?? '' }}</div>
                                            </div><!--//resume-timeline-item-header-->
                                            <div class="resume-timeline-item-desc">
                                                <p style="white-space: pre-wrap; overflow-wrap: break-word">{{ $work_experience->description ?? '' }}</p>
                                            </div>
                                        </article>
                                    </div>
                                    @empty
                ...
                <div class="col-lg-3">
                    <section class="resume-section skills-section mb-5">
                        ...
                        <div class="resume-section-content">
                            @forelse ($resume['content']->skills as $skill)
                            ...
                            <div class="resume-skill-item">
                                <h4 class="resume-skills-cat font-weight-bold">Non professionnel</h4>
                                {{-- <ul class="list-inline">
                                    <li class="list-inline-item"><span class="badge badge-light">Équitation</span></li>
                                    <li class="list-inline-item"><span class="badge badge-light">Guitare</span></li>
                    ...
                    <section class="resume-section education-section mb-5">
                        <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Éducation</h2>
                        <div class="resume-section-content">
                            <ul class="list-unstyled">
                                @forelse ($resume['content']->education as $education)
                                    <li class="mb-2">
                                        <div class="resume-degree font-weight-bold">{{ $education->education ?? ""}}</div>
                                        <div class="resume-degree-org">{{ $education->school ?? ""}} {{ $education->city ?? ""}}</div>
                                        <div class="resume-degree-time">{{ $education->start_date_year ?? "" }} — {{ $education->end_date_year ?? "" }}</div>
                                    </li>
                                @empty
                                {{-- empty --}}
                                @endforelse
                    ...
                    <section class="resume-section reference-section mb-5">
                        ...
                        <div class="resume-section-content">
                            <ul class="list-unstyled resume-awards-list">
                                @forelse ($resume['content']->languages as $language)
                                    <li class="mb-2 pl-4 position-relative">
                                        ...
                                        <div class="resume-award-name">{{ $language->language ?? "" }}</div>
                                        <div class="resume-award-desc">{{ $language->level ?? 0 }} / 10</div>
                                    </li>
                                @empty
                                {{-- empty --}}
                                @endforelse
